        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-8">
            ...
            <div className='flex justify-between p-4 border-t border-gray-200'>
              ...
              <button 
                onClick={clearCart}
                className='text-blue-500 cursor-pointer p-2 rounded-lg border border-gray-300'
              >Remove all</button>
            </div>
            </div>
            ...
            <div className="mt-6 mb-6 bg-white rounded-lg border border-gray-200 p-6">
              ...
              <div className="flex gap-5 justify-between">
                {products.map((product) => (         
                  <div className="flex flex-col gap-4 w-80" key={product._id}>
                    <div className='flex items-center justify-center border border-gray-300 rounded-lg'>
                      <img
                        src={product.mainImage}
                        alt={product.name}
                        className="w-[80%] h-[90%] object-cover rounded bg-gray-300"
                      />
                    </div>
                    <div className="flex flex-col gap-2">
                      <p className="text-xl font-semibold">{product.price}</p>
                      <h3 className="text-xl text-gray-400 mb-1 mt-1">{product.name}</h3>
